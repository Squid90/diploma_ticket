  ...
  return (
    <>
        ...
        <div className='about_text'>
            ...
            <p><span id='span__aboutText'>Покупать жд билеты дешево можно за 90 суток до отправления поезда.</span></p>
            <p><span id='span__aboutText'>Благодаря динамическому ценообразованию цена на билеты в это время самая низкая.</span></p>
        </div>
    </>
  )
}
